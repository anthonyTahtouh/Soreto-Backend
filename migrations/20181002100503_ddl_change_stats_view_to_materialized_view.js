export function up(knex) {
  var query = `
        ...
        CREATE MATERIALIZED VIEW reverb.agg_campaign_version_stats_daily_js AS
          SELECT dates.date,
            ...
            sum(COALESCE(shared_url_order.totalsales, 0::bigint::numeric)) * (COALESCE(client.percent_commission->>'default', '0')::numeric/100) as "totalCommissionSoretoSales"
