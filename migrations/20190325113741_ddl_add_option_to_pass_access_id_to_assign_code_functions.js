export function up(knex) {
  ...
  AS $BODY$
          ...
          IF (FOUND) THEN	
              UPDATE reverb.reward_discount_code set attributed_user_id = p_user_id, shared_url_access_id = p_shared_url_accessed_id, updated_at = current_date WHERE reward_discount_code._id = discount_code_rec.reward_discount_code_id;
