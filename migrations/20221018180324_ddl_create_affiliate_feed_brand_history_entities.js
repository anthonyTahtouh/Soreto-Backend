exports.up = function(knex) {
  var query = `
      ...
      CREATE TABLE reverb.mp_affiliate_feed_brand_history (
...
exports.down = function(knex) {
  var query = ` 
        ...
        DROP VIEW IF EXISTS reverb.mp_affiliate_feed_brand_history_js;
  
        DROP TABLE reverb.mp_affiliate_feed_brand_history;
      `;
  return knex.schema.raw(query);
};
