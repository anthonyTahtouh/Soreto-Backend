export function up(knex) {
  var query = `
    DROP VIEW reverb.agg_campaign_version_stats_daily_js;
    ...
    FROM reverb.shared_url shared_url
        ...
        LEFT JOIN reverb.campaign campaign ON client._id = campaign.client_id AND shared_url.campaign_id = campaign._id
        LEFT JOIN reverb.campaign_version campaign_version ON campaign._id = campaign_version.campaign_id AND shared_url.campaign_version_id = campaign_version._id
