export function up(knex) {
  var query = `CREATE OR REPLACE FUNCTION reverb.func_assign_referrer_reward_discount_code(
  ...
  AS $BODY$      
          ...
          RETURNING code, value_amount, discount_type, valid_from, valid_to INTO discount_code_rec;
