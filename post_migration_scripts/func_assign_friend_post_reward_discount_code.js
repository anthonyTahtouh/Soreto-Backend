exports.seed = function(knex) {
  return knex.raw(` 
    ...
    CREATE OR REPLACE FUNCTION reverb.func_assign_friend_post_reward_discount_code(p_campaign_version_id text, p_reward_type text, p_user_id text)
    RETURNS json
    LANGUAGE plpgsql
    AS $function$
               ...
               reward_discount_code._id = (
                 ...
                 from
                     ...
                     join reverb.reward_discount_code rdc
                         on rp.friend_post_reward_id = rdc.reward_id
                 WHERE 
    ...
    $function$;
     ...
     CREATE OR REPLACE FUNCTION reverb.func_assign_friend_post_reward_discount_code(p_campaign_version_id text, p_reward_type text, p_user_id text, p_shared_url_accessed_id text)
     RETURNS json
     LANGUAGE plpgsql
     AS $function$
               DECLARE
