echo
echo -e "\033[30;42mPreparing testing environment for debugging ...\033[m";
echo
...
sleep 5
echo
echo -e "\033[30;42mYou can debug your tests now! =)\033[m";
echo
read -p "Press any key to destroy testing environment..."
